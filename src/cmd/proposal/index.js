...
export default async (yargs: Argv) => {
  yargs
    ...
    .command('create-proposal-change-contract-admin', 'Create a new proposal for the network to change cosmwasm contract admin', require('./cmd/create-proposal-change-contract-admin').default)
